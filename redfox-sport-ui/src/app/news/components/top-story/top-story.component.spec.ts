...
describe('TopStoryComponent', () => {
  ...
  beforeEach(() => {
    ...
    component.article = {
      ...
      url: 'https://www.geo.tv/latest/285856-batting-great-kumar-sangakkara-england-australia-must-tour-pakistan',
      urlToImage: 'https://www.geo.tv/assets/uploads/updates/2020-05-01/285856_114933_updates.jpg',
